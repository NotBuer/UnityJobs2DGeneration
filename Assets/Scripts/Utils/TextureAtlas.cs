...
public static class TextureAtlas
{
    ...
    public static VertexLayout.UVLayout GetUVTextureForTile(TileData tileData, TexCoord texCoord) 
    {
        return tileData.Type switch
        {
            ...
            {
                TexCoord.LEFT_BOTTOM => new VertexLayout.UVLayout(new(0f), new((OFFSET_Y * 15) - OFFSET_Y)),
                TexCoord.LEFT_TOP => new VertexLayout.UVLayout(new(0f), new(OFFSET_Y * 15)),
                TexCoord.RIGHT_TOP => new VertexLayout.UVLayout(new(OFFSET_X), new(OFFSET_Y * 15)),
                TexCoord.RIGHT_BOTTOM => new VertexLayout.UVLayout(new(OFFSET_X), new((OFFSET_Y * 15) - OFFSET_Y)),
                _ => VertexLayout.UVLayout.Default,
            },
            _ => texCoord switch
            {
